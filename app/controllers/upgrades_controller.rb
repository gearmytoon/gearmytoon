class UpgradesController < ApplicationController
  ...
  def raid_25
    @raids = Area.raids_25
    @title = "25-Player Raid Upgrades for #{@character.name.capitalize} of #{@character.realm.capitalize} &mdash; gearmytoon.com"
    render "raids"
  end

  def raid_10
    @raids = Area.raids_10
    @title = "10-Player Raid Upgrades for #{@character.name.capitalize} of #{@character.realm.capitalize} &mdash; gearmytoon.com"
    render "raids"
  end
end
